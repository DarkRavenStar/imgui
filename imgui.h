...
namespace ImGui
{
    ...
    IMGUI_API bool          CollapsingHeaderComponentGUI(const char* label, ImGuiTreeNodeFlags flags = 0, ImTextureID iconTextureID = nullptr);  // if returning 'true' the header is open. doesn't indent nor push on ID stack. user doesn't have to call TreePop().
